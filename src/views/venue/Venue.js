...
export default function Venue(){
    return (
      ...
      <div className="d-flex mt-2 align-items-center justify-content-between">
        <b className="ml-n2 font-weight-bold">Venue List</b>
            <div className="d-flex align-items-center">

                <Link to="/venue/add" className="btn mx-1 bg-lightpurple shadow-none rounded-pill text-nowrap"><small>+ Add New Venue</small></Link>
